...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "hero.badge": "v0.2.3 · React + Tauri · MIT 开源",
      ...
      "dl.sub": "当前版本 v0.2.3。下载页提供 macOS 双架构 DMG 与 Windows x64 安装程序。",
      "dl.rec": "推荐",
    ...
    en: {
      ...
      "hero.badge": "v0.2.3 · React + Tauri · MIT open source",
      ...
      "dl.sub": "Current version v0.2.3. The download page provides dual-architecture macOS DMGs and a Windows x64 installer.",
      "dl.rec": "Recommended",
