...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "how.s1t": "下载安装",
      "how.s1d": "一个 DMG 或 EXE，拖进应用程序即完成安装。不需要自己装 Node，不需要敲任何命令。",
      "how.s2t": "双击启动",
      ...
      "dl.sub": "当前版本 v0.1.0。以下链接始终指向 GitHub Releases 的最新发布。",
      "dl.rec": "推荐",
      "dl.macArm": "Apple Silicon（M 系列芯片）",
      "dl.macIntel": "Intel 芯片",
      "dl.btn": "下载 DMG",
      "dl.btnExe": "下载 EXE",
      "dl.note1": "尚未配置代码签名：macOS 为 ad-hoc 签名，首次启动请右键「打开」；Windows 可能出现 SmartScreen 提示，选择「仍要运行」即可。",
      "dl.all": "查看全部历史版本 →",
    ...
    en: {
      ...
      "hero.badge": "v0.1.0 early preview · MIT open source",
      ...
      "how.s1d": "One DMG or EXE — drag it into Applications and you're done. No Node to install, no commands to type.",
      ...
      "dl.sub": "Current version v0.1.0. These links always point to the latest GitHub Release.",
      "dl.rec": "Recommended",
      "dl.macArm": "Apple Silicon (M-series)",
      "dl.macIntel": "Intel",
      "dl.btn": "Download DMG",
      "dl.btnExe": "Download EXE",
      "dl.note1": "No code-signing certificate is configured yet: macOS builds are ad-hoc signed, so right-click \"Open\" on first launch; Windows may show a SmartScreen prompt — choose \"Run anyway\".",
