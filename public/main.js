...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "how.s1t": "下载安装",
      "how.s1d": "macOS 下载 DMG，Windows 下载 ZIP 并解压。不需要自己装 Node，不需要敲任何命令。",
      "how.s2t": "双击启动",
      ...
      "feat.f8t": "数据隔离",
      "feat.f8d": "服务数据独立存放于 ~/.dsh-desktop/dsh-home，可与已有的 ~/.dsh 做一次性的缺失项导入，互不覆盖。",

      "dl.kicker": "下载",
      "dl.title": "选择你的平台<span class=\"grad\">开始</span>",
      "dl.sub": "当前版本 v0.1.1。以下链接始终指向 GitHub Releases 的最新发布。",
      "dl.rec": "推荐",
      "dl.macArm": "Apple Silicon（M 系列芯片）",
      "dl.macIntel": "Intel 芯片",
      "dl.btn": "下载 DMG",
      "dl.btnZip": "下载 ZIP",
      "dl.note1": "Windows 使用非自解压 ZIP 目录包以降低杀毒软件误报；解压后运行 DSHLauncher.exe。macOS 当前为 ad-hoc 签名，首次启动请右键「打开」。",
      "dl.all": "查看全部历史版本 →",
    ...
    en: {
      ...
      "hero.badge": "v0.1.1 early preview · MIT open source",
      ...
      "how.s1d": "Download a DMG on macOS, or download and extract the ZIP on Windows. No Node to install, no commands to type.",
      ...
      "feat.f8d": "Service data lives in ~/.dsh-desktop/dsh-home and can absorb missing entries from an existing ~/.dsh exactly once — never overwriting either side.",

      "dl.kicker": "Download",
      "dl.title": "Pick your platform <span class=\"grad\">and start</span>",
      "dl.sub": "Current version v0.1.1. These links always point to the latest GitHub Release.",
      "dl.rec": "Recommended",
      "dl.macArm": "Apple Silicon (M-series)",
      "dl.macIntel": "Intel",
      "dl.btn": "Download DMG",
      "dl.btnZip": "Download ZIP",
      "dl.note1": "Windows uses a non-self-extracting ZIP directory package to reduce antivirus false positives; extract it, then run DSHLauncher.exe. macOS is currently ad-hoc signed, so right-click \"Open\" on first launch.",
